...
io.sockets.on('connection', function(socket){
	...
	*/
	...
	/*When a web page idsconnects alert everyone in the same room*/
...
socket.on('send_message', function(payload){
	...
	*/
	...
	socket.on('uninvite', function(payload){
		...
		/*Tell the unvitee that they have been uninvited*/
		var success_data = {
			result: 'success',
			socket_id: socket.id
		};
	...
	*/
	...
	socket.on('game_start', function(payload){
		...
		/*If everything is okay responsed to the game_starter that it was successful*/
	...
	*/
	...
	socket.on('play_token', function(payload){
		...
		if(('undefined' === typeof column) || !color || (color != 'white' && color != 'black')) {
...
/*********************************************************/
/*           Code related to the game start              */
...
function send_game_update(socket, game_id, message){
	...
	/*If the current player isn't assignd a color*/
